/**
 * @module KlassHistoryController
 * Module that contains the KlassHistory controller
 * @author R.Wood
 * Date: 02/04/2019
 * @requires module:models/klass-history
 * @requires module:checkers.checkReqFields
 * @requires module:klassHistoryConstants.error-messages
 * @requires module:verification/klass
 * @requires module:verification/klassHistory
 */

/** @see module:models/klass-history */
 const KlassHistory = require('../models/klass-history');

/** @see module:checkers.checkReqFields */
const { checkReqFields } = require('../helpers/checkers');

/** @see module:klassHistoryConstants.errMsgs */
const errMsgs = require('../constants/klass-history-msgs');

/** @see module:verification/klassHistory */
const klassHistoryVerifiers = require('../verification/klass-history');
...
function resolveReqWSemester(req, res, next) {
    ...
    */
    ...
    /** @see module:verification/klassHistory.validateSemesterField */
    klassHistoryVerifiers.validateSemesterField(kH)
        .then(semesterCheck => {
...
/** @exports klassHistoryController */
module.exports = {
    /**
    ...
    create (req, res, next) {
        ...
        /** @see module:klassHistoryVerifiers.validateYear */
        klassHistoryVerifiers.validateYear(req);
